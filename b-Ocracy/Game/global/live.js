...
isMobile = true;
document.body.innerHTML="<div id=logo style='width:100%;height:100%;background:#343838'><img src=../assets/backgrounds/title.svg style='width:80%;position:absolute;margin:auto;left:0;right:0;top:0;bottom:0'></div><div id=mainWrapper style='width:100%;height:100%;display:none'>"+document.body.innerHTML+"</div>";
...
function ld() { setTimeout(function(){$('logo').style.display='none';$('mainWrapper').style.display = ""},1000) }
